...
* . ^alias[+] = "CRF"
* . ^alias[+] = "Survey"
* url 0..1 SU uri "Canonical identifier for this questionnaire, represented as a URI (globally unique)" "An absolute URI that is used to identify this questionnaire when it is referenced in a specification, model, design or an instance; also called its canonical identifier. This SHOULD be globally unique and SHOULD be a literal address at which at which an authoritative instance of this questionnaire is (or will be) published. This URL can be the target of a canonical reference. It SHALL remain the same when the questionnaire is stored on different servers."
...
* identifier 0..0 SU Identifier "Additional identifier for the questionnaire" "A formal identifier that is used to identify this questionnaire when it is represented in other formats, or referenced in a specification, model, design or an instance."
...
* derivedFrom 0..0 Canonical(http://hl7.org/fhir/StructureDefinition/Questionnaire) "Instantiates protocol or definition" "The URL of a Questionnaire that this Questionnaire is based on."
...
* experimental 0..1 SU boolean "For testing purposes, not real usage" "A Boolean value to indicate that this questionnaire is authored for testing purposes (or education/evaluation/marketing) and is not intended to be used for genuine usage."
...
* subjectType 0..0 SU code "Resource that can be subject of QuestionnaireResponse" "The types of subjects that can be the subject of responses created for the questionnaire."
...
* date 0..1 SU dateTime "Date last changed" "The date  (and optionally time) when the questionnaire was published. The date must change when the business version changes and it must change if the status code changes. In addition, it should change when the substantive content of the questionnaire changes."
...
* publisher 0..1 SU string "Name of the publisher (organization or individual)" "The name of the organization or individual that published the questionnaire."
...
* contact 0..0 SU ContactDetail "Contact details for the publisher" "Contact details to assist a user in finding and communicating with the publisher."
* contact ^comment = "May be a web site, an email address, a telephone number, etc."
* description 0..1 markdown "Natural language description of the questionnaire" "A free text natural language description of the questionnaire from a consumer's perspective."
...
* jurisdiction 0..0 SU CodeableConcept "Intended jurisdiction for questionnaire (if applicable)" "A legal or geographic region in which the questionnaire is intended to be used."
...
* lastReviewDate 0..1 date "When the questionnaire was last reviewed" "The date on which the resource content was last reviewed. Review happens periodically after approval but does not change the original approval date."
...
* code 0..0 SU Coding "Concept that represents the overall questionnaire" "An identifier for this question or group of questions in a particular terminology such as LOINC."
...
* item 0..0 BackboneElement "Questions and sections within the Questionnaire" "A particular question, question grouping or display text that is part of the questionnaire."
...
* item.definition 0..1 uri "ElementDefinition - details for the item" "This element is a URI that refers to an [ElementDefinition](elementdefinition.html) that provides information about this item, including information that might otherwise be included in the instance of the Questionnaire resource. A detailed description of the construction of the URI is shown in Comments, below. If this element is present then the following element values MAY be derived from the Element Definition if the corresponding elements of this Questionnaire resource instance have no value:\n\n* code (ElementDefinition.code) \n* type (ElementDefinition.type) \n* required (ElementDefinition.min) \n* repeats (ElementDefinition.max) \n* maxLength (ElementDefinition.maxLength) \n* answerValueSet (ElementDefinition.binding)\n* options (ElementDefinition.binding)."
...
* item.code 0..0 Coding "Corresponding concept for this item in a terminology" "A terminology code that corresponds to this group or question (e.g. a code from LOINC, which defines many questions and answers)."
...
* item.enableWhen 0..0 ?! BackboneElement "Only allow data when" "A constraint indicating that this item should only be enabled (displayed/allow answers to be captured) when the specified condition is true."
...
* item.repeats 0..1 boolean "Whether the item may repeat" "An indication, if true, that the item may occur multiple times in the response, collecting multiple answers for questions or multiple sets of answers for groups."
...
* item.maxLength 0..1 integer "No more than this many characters" "The maximum number of characters that are permitted in the answer to be considered a \"valid\" QuestionnaireResponse."
...
* item.answerValueSet 0..1 Canonical(http://hl7.org/fhir/StructureDefinition/ValueSet) "Valueset containing permitted answers" "A reference to a value set containing a list of codes representing permitted answers for a \"choice\" or \"open-choice\" question."
...
* item.answerOption 0..0 BackboneElement "Permitted answer" "One of the permitted answers for a \"choice\" or \"open-choice\" question."
...
* item.initial 0..0 BackboneElement "Initial value(s) when item is first rendered" "One or more values that should be pre-populated in the answer when initially rendering the questionnaire for user input."
