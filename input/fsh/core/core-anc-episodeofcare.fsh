...
* identifier 0..0 Identifier "Business Identifier(s) relevant for this EpisodeOfCare" "The EpisodeOfCare may be known by different identifiers for different contexts of use, such as when an external agency is tracking the Episode for funding purposes."
...
* statusHistory 0..0 BackboneElement "Past list of status codes (the current status may be included to cover the start date of the status)" "The history of statuses that the EpisodeOfCare has been through (without requiring processing the history of the resource)."
...
* type 1..1 MS SU CodeableConcept "Type/class  - e.g. specialist referral, disease management" "A classification of the type of episode of care; e.g. specialist referral, disease management, type of funded care."
* type from http://hl7.org/fhir/ValueSet/episodeofcare-type (example)
* type ^comment = "Specify the type of EpisodeofCare, ANC is used for antenatal care."
* type ^fixedCode = #ANC
...
* diagnosis 0..0 SU BackboneElement "The list of diagnosis relevant to this episode of care" "The list of diagnosis relevant to this episode of care."
...
* diagnosis.role 0..1 SU CodeableConcept "Role that this diagnosis has within the episode of care (e.g. admission, billing, discharge …)" "Role that this diagnosis has within the episode of care (e.g. admission, billing, discharge …)."
...
* diagnosis.rank 0..1 SU positiveInt "Ranking of the diagnosis (for each role type)" "Ranking of the diagnosis (for each role type)."
...
* managingOrganization 0..1 SU Reference(http://hl7.org/fhir/StructureDefinition/Organization) "Organization that assumes care" "The organization that has assumed the specific responsibilities for the specified duration."
* period 0..1 SU Period "Interval during responsibility is assumed" "The interval during which the managing organization assumes the defined responsibility."
* referralRequest 0..0 Reference(http://hl7.org/fhir/StructureDefinition/ServiceRequest) "Originating Referral Request(s)" "Referral Request(s) that are fulfilled by this EpisodeOfCare, incoming referrals."
* careManager 0..1 Reference(http://hl7.org/fhir/StructureDefinition/Practitioner or http://hl7.org/fhir/StructureDefinition/PractitionerRole) "Care manager/care coordinator for the patient" "The practitioner that is the care manager/care coordinator for this patient."
* team 0..0 Reference(http://hl7.org/fhir/StructureDefinition/CareTeam) "Other practitioners facilitating this episode of care" "The list of practitioners that may be facilitating this episode of care for specific purposes."
* team ^alias = "CareTeam"
* account 0..0 Reference(http://hl7.org/fhir/StructureDefinition/Account) "The set of accounts that may be used for billing for this EpisodeOfCare" "The set of accounts that may be used for billing for this EpisodeOfCare."
