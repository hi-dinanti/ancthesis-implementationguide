...
* statusHistory 0..1 BackboneElement "List of past encounter statuses" "The status history permits the encounter resource to contain the status history without needing to read through the historical versions of the resource, or even have the server store them."
...
* classHistory 0..1 BackboneElement "List of past encounter classes" "The class history permits the tracking of the encounters transitions without needing to go  through the resource history.  This would be used for a case where an admission starts of as an emergency encounter, then transitions into an inpatient scenario. Doing this and not restarting a new encounter ensures that any lab/diagnostic results can more easily follow the patient and not require re-processing and not get lost or cancelled during a kind of discharge from emergency to inpatient."
...
* type 0..1 SU CodeableConcept "Specific type of encounter" "Specific type of encounter (e.g. e-mail consultation, surgical day-care, skilled nursing, rehabilitation)."
...
* episodeOfCare 0..1 SU Reference(http://hl7.org/fhir/StructureDefinition/EpisodeOfCare) "Episode(s) of care that this encounter should be recorded against" "Where a specific encounter should be classified as a part of a specific episode(s) of care this field should be used. This association can facilitate grouping of related encounters together for a specific purpose, such as government reporting, issue tracking, association via a common problem.  The association is recorded on the encounter as these are typically created after the episode of care and grouped on entry rather than editing the episode of care to append another encounter to it (the episode of care could span years)."
* basedOn 0..1 Reference(http://hl7.org/fhir/StructureDefinition/ServiceRequest) "The ServiceRequest that initiated this encounter" "The request this encounter satisfies (e.g. incoming referral or procedure request)."
* basedOn ^alias[0] = "incomingReferral"
* participant 0..1 SU BackboneElement "List of participants involved in the encounter" "The list of people responsible for providing the service."
* participant.type 0..1 SU CodeableConcept "Role of participant in encounter" "Role of participant in encounter."
...
* appointment 0..1 SU Reference(http://hl7.org/fhir/StructureDefinition/Appointment) "The appointment that scheduled this encounter" "The appointment that scheduled this encounter."
...
* reasonCode 0..1 SU CodeableConcept "Coded reason the encounter takes place" "Reason the encounter takes place, expressed as a code. For admissions, this can be used for a coded admission diagnosis."
...
* diagnosis 0..1 SU BackboneElement "The list of diagnosis relevant to this encounter" "The list of diagnosis relevant to this encounter."
...
* account 0..1 Reference(http://hl7.org/fhir/StructureDefinition/Account) "The set of accounts that may be used for billing for this Encounter" "The set of accounts that may be used for billing for this Encounter."
...
* hospitalization.dietPreference 0..1 CodeableConcept "Diet preferences reported by the patient" "Diet preferences reported by the patient."
...
* hospitalization.specialCourtesy 0..1 CodeableConcept "Special courtesies (VIP, board member)" "Special courtesies (VIP, board member)."
...
* hospitalization.specialArrangement 0..1 CodeableConcept "Wheelchair, translator, stretcher, etc." "Any special requests that have been made for this hospitalization encounter, such as the provision of specific equipment or other things."
...
* location 0..1 BackboneElement "List of locations where the patient has been" "List of locations where  the patient has been during this encounter."
