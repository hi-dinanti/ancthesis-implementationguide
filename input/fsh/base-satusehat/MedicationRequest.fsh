...
* ^meta.lastUpdated = "2022-10-05T04:55:02.2778307+00:00"
...
* reported[x] undefined..1 SU boolean or Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Patient or https://fhir.kemkes.go.id/r4/StructureDefinition/Practitioner or https://fhir.kemkes.go.id/r4/StructureDefinition/PractitionerRole or https://fhir.kemkes.go.id/r4/StructureDefinition/RelatedPerson or https://fhir.kemkes.go.id/r4/StructureDefinition/Organization) "Reported rather than primary record" "Indicates if this record was captured as a secondary 'reported' record rather than as an original primary source-of-truth record.  It may also indicate the source of the report."
* medication[x] 1..1 SU CodeableConcept or Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Medication) "Medication to be taken" "Identifies the medication being requested. This is a link to a resource that represents the medication which may be the details of the medication or simply an attribute carrying a code that identifies the medication from a known list of medications."
...
* subject 1..1 SU Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Patient or https://fhir.kemkes.go.id/r4/StructureDefinition/Group) "Who or group medication request is for" "A link to a resource representing the person or set of individuals to whom the medication will be given."
...
* encounter undefined..1 Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Encounter) "Encounter created as part of encounter/admission/stay" "The Encounter during which this [x] was created or to which the creation of this record is tightly associated."
...
* supportingInformation undefined..undefined Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Resource) "Information to support ordering of the medication" "Include additional information (for example, patient height and weight) that supports the ordering of the medication."
...
* requester undefined..1 SU Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Practitioner or https://fhir.kemkes.go.id/r4/StructureDefinition/PractitionerRole or https://fhir.kemkes.go.id/r4/StructureDefinition/Organization or https://fhir.kemkes.go.id/r4/StructureDefinition/Patient or https://fhir.kemkes.go.id/r4/StructureDefinition/RelatedPerson or https://fhir.kemkes.go.id/r4/StructureDefinition/Device) "Who/What requested the Request" "The individual, organization, or device that initiated the request and has responsibility for its activation."
* performer undefined..1 Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Practitioner or https://fhir.kemkes.go.id/r4/StructureDefinition/PractitionerRole or https://fhir.kemkes.go.id/r4/StructureDefinition/Organization or https://fhir.kemkes.go.id/r4/StructureDefinition/Patient or https://fhir.kemkes.go.id/r4/StructureDefinition/Device or https://fhir.kemkes.go.id/r4/StructureDefinition/RelatedPerson or https://fhir.kemkes.go.id/r4/StructureDefinition/CareTeam) "Intended performer of administration" "The specified desired performer of the medication treatment (e.g. the performer of the medication administration)."
...
* recorder undefined..1 Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Practitioner or https://fhir.kemkes.go.id/r4/StructureDefinition/PractitionerRole) "Person who entered the request" "The person who entered the order on behalf of another individual for example in the case of a verbal or a telephone order."
...
* reasonReference undefined..undefined Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Condition or https://fhir.kemkes.go.id/r4/StructureDefinition/Observation) "Condition or observation that supports why the prescription is being written" "Condition or observation that supports why the medication was ordered."
...
* basedOn undefined..undefined SU Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/CarePlan or https://fhir.kemkes.go.id/r4/StructureDefinition/MedicationRequest or https://fhir.kemkes.go.id/r4/StructureDefinition/ServiceRequest or https://fhir.kemkes.go.id/r4/StructureDefinition/ImmunizationRecommendation) "What request fulfills" "A plan or request that is fulfilled in whole or in part by this medication request."
...
* courseOfTherapyType ^binding.extension.url = "https://fhir.kemkes.go.id/r4/StructureDefinition/elementdefinition-bindingName"
...
* dispenseRequest.initialFill.quantity undefined..1 https://fhir.kemkes.go.id/r4/StructureDefinition/SimpleQuantity "First fill quantity" "The amount or quantity to provide as part of the first dispense."
...
* dispenseRequest.quantity undefined..1 https://fhir.kemkes.go.id/r4/StructureDefinition/SimpleQuantity "Amount of medication to supply per dispense" "The amount that is to be dispensed for one fill."
...
* dispenseRequest.performer undefined..1 Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Organization) "Intended dispenser" "Indicates the intended dispensing Organization specified by the prescriber."
...
* substitution.allowed[x] ^binding.extension.url = "https://fhir.kemkes.go.id/r4/StructureDefinition/elementdefinition-bindingName"
...
* substitution.reason ^binding.extension.url = "https://fhir.kemkes.go.id/r4/StructureDefinition/elementdefinition-bindingName"
...
* priorPrescription undefined..1 Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/MedicationRequest) "An order/prescription that is being replaced" "A link to a resource representing an earlier order related order or prescription."
* detectedIssue undefined..undefined Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/DetectedIssue) "Clinical Issue with action" "Indicates an actual or potential clinical issue with or between one or more active or proposed clinical actions for a patient; e.g. Drug-drug interaction, duplicate therapy, dosage alert etc."
...
* eventHistory undefined..undefined Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Provenance) "A list of events of interest in the lifecycle" "Links to Provenance records for past versions of this resource or fulfilling request or event resources that identify key state transitions or updates that are likely to be relevant to a user looking at the current version of the resource."
