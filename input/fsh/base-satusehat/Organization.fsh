...
* identifier 0..* SU Identifier "Identifies this organization  across multiple systems" "Identifier for the organization that is used to identify the organization across multiple disparate systems."
...
* active 0..1 ?! SU boolean "Whether the organization's record is still in active use" "Whether the organization's record is still in active use."
...
* type 0..* SU CodeableConcept "Kind of organization" "The kind(s) of organization that this is."
...
* name 0..1 SU string "Name used for the organization" "A name associated with the organization."
...
* alias 0..* string "A list of alternate names that the organization is known as, or was known as in the past" "A list of alternate names that the organization is known as, or was known as in the past."
...
* telecom 0..* ContactPoint "A contact detail for the organization" "A contact detail for the organization."
* telecom obeys org-3
...
* address 0..* https://fhir.kemkes.go.id/r4/StructureDefinition/Address "An address for the organization" "An address for the organization."
* address obeys org-2
...
* partOf 0..1 SU Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Organization) "The organization of which this organization forms a part" "The organization of which this organization forms a part."
...
* contact 0..* BackboneElement "Contact for the organization for a certain purpose" "Contact for the organization for a certain purpose."
...
* contact.purpose 0..1 CodeableConcept "The type of contact" "Indicates a purpose for which the contact can be reached."
...
* contact.purpose ^binding.extension.url = "https://fhir.kemkes.go.id/r4/StructureDefinition/elementdefinition-bindingName"
...
* contact.name 0..1 HumanName "A name associated with the contact" "A name associated with the contact."
* contact.name ^requirements = "Need to be able to track the person by name."
* contact.telecom 0..* ContactPoint "Contact details (telephone, email, etc.)  for a contact" "A contact detail (e.g. a telephone number or an email address) by which the party may be contacted."
* contact.telecom ^requirements = "People have (primary) ways to contact them in some way such as phone, email."
* contact.address 0..1 Address "Visiting or postal addresses for the contact" "Visiting or postal addresses for the contact."
...
* endpoint 0..* Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Endpoint) "Technical endpoints providing access to services operated for the organization" "Technical endpoints providing access to services operated for the organization."
