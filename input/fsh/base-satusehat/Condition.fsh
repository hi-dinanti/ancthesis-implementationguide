...
* ^meta.lastUpdated = "2022-09-29T07:50:14.3704526+00:00"
...
* subject 1..1 SU Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Patient or https://fhir.kemkes.go.id/r4/StructureDefinition/Group) "Who has the condition?" "Indicates the patient or group who the condition record is associated with."
* subject ^requirements = "Group is typically used for veterinary or public health use cases."
* subject ^alias = "patient"
* encounter 1..1 SU Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Encounter) "Encounter created as part of" "The Encounter during which this Condition was created or to which the creation of this record is tightly associated."
...
* evidence.code ^binding.extension.url = "https://fhir.kemkes.go.id/r4/StructureDefinition/elementdefinition-bindingName"
...
* evidence.detail undefined..undefined SU Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Resource) "Supporting information found elsewhere" "Links to other relevant information, including pathology reports."
