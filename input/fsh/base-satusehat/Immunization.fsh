...
* status 1..1 ?! SU code "completed | entered-in-error | not-done" "Indicates the current status of the immunization event."
...
* patient 1..1 SU Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Patient) "Who was immunized" "The patient who either received or did not receive the immunization."
* encounter undefined..1 Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Encounter) "Encounter immunization was part of" "The visit or admission or other contact between patient and health care provider the immunization was performed as part of."
...
* location undefined..1 Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Location) "Where immunization occurred" "The service delivery location where the vaccine administration occurred."
* manufacturer undefined..1 Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Organization) "Vaccine manufacturer" "Name of vaccine manufacturer."
...
* doseQuantity undefined..1 https://fhir.kemkes.go.id/r4/StructureDefinition/SimpleQuantity "Amount of vaccine administered" "The quantity of vaccine product that was administered."
...
* reaction.detail undefined..1 Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Observation) "Additional information on reaction" "Details of the reaction."
...
* protocolApplied.authority undefined..1 Reference(https://fhir.kemkes.go.id/r4/StructureDefinition/Organization) "Who is responsible for publishing the recommendations" "Indicates the authority who published the protocol (e.g. ACIP) that is being followed."
