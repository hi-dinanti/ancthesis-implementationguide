...
* identifier 0..0 SU Identifier "A human identifier for this person" "Identifier for a person within a particular scope."
...
* active 0..1 ?! SU boolean "Whether this related person's record is in active use" "Whether this related person record is in active use."
...
* relationship 0..0 SU CodeableConcept "The nature of the relationship" "The nature of the relationship between a patient and the related person."
...
* birthDate 0..1 SU date "The date on which the related person was born" "The date on which the related person was born."
* address 0..0 SU Address "Address where the related person can be contacted or visited" "Address where the related person can be contacted or visited."
...
* period 0..1 Period "Period of time that this relationship is considered valid" "The period of time during which this relationship is or was active. If there are no dates defined, then the interval is unknown."
* communication 0..0 BackboneElement "A language which may be used to communicate with about the patient's health" "A language which may be used to communicate with about the patient's health."
...
* communication.preferred 0..1 boolean "Language preference indicator" "Indicates whether or not the patient prefers this language (over other languages he masters up a certain level)."
