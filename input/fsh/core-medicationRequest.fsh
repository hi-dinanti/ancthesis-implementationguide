...
* category 0..0 CodeableConcept "Type of medication usage" "Indicates the type of medication request (for example, where the medication is expected to be consumed or administered (i.e. inpatient or outpatient))."
...
* supportingInformation 0..0 Reference(http://hl7.org/fhir/StructureDefinition/Resource) "Information to support ordering of the medication" "Include additional information (for example, patient height and weight) that supports the ordering of the medication."
...
* reasonCode 0..0 CodeableConcept "Reason or indication for ordering or not ordering the medication" "The reason or the indication for ordering or not ordering the medication."
...
* reasonReference 0..0 Reference(http://hl7.org/fhir/StructureDefinition/Condition or http://hl7.org/fhir/StructureDefinition/Observation) "Condition or observation that supports why the prescription is being written" "Condition or observation that supports why the medication was ordered."
...
* instantiatesCanonical 0..0 SU canonical "Instantiates FHIR protocol or definition" "The URL pointing to a protocol, guideline, orderset, or other definition that is adhered to in whole or in part by this MedicationRequest."
* instantiatesUri 0..0 SU uri "Instantiates external protocol or definition" "The URL pointing to an externally maintained protocol, guideline, orderset or other definition that is adhered to in whole or in part by this MedicationRequest."
* basedOn 0..0 SU Reference(http://hl7.org/fhir/StructureDefinition/CarePlan or http://hl7.org/fhir/StructureDefinition/MedicationRequest or http://hl7.org/fhir/StructureDefinition/ServiceRequest or http://hl7.org/fhir/StructureDefinition/ImmunizationRecommendation) "What request fulfills" "A plan or request that is fulfilled in whole or in part by this medication request."
...
* insurance 0..0 Reference(http://hl7.org/fhir/StructureDefinition/Coverage or http://hl7.org/fhir/StructureDefinition/ClaimResponse) "Associated insurance coverage" "Insurance plans, coverage extensions, pre-authorizations and/or pre-determinations that may be required for delivering the requested service."
* note 0..0 Annotation "Information about the prescription" "Extra information about the prescription that could not be conveyed by the other attributes."
* dosageInstruction 0..0 Dosage "How the medication should be taken" "Indicates how the medication is to be used by the patient."
