...
* identifier 0..0 SU Identifier "External Ids for this condition" "Business identifiers assigned to this condition by the performer or other systems which remain constant as the resource is updated and propagates from server to server."
...
* clinicalStatus 0..1 ?! SU CodeableConcept "active | recurrence | relapse | inactive | remission | resolved" "The clinical status of the condition."
...
* verificationStatus 0..1 ?! SU CodeableConcept "unconfirmed | provisional | differential | confirmed | refuted | entered-in-error" "The verification status to support the clinical status of the condition."
...
* category 0..0 CodeableConcept "problem-list-item | encounter-diagnosis" "A category assigned to the condition."
...
* bodySite 0..0 SU CodeableConcept "Anatomical location, if relevant" "The anatomical location where this condition manifests itself."
...
* recordedDate 0..1 SU dateTime "Date record was first recorded" "The recordedDate represents when this particular Condition record was created in the system, which is often a system-generated date."
* recorder 0..1 SU Reference(http://hl7.org/fhir/StructureDefinition/Practitioner or http://hl7.org/fhir/StructureDefinition/PractitionerRole or http://hl7.org/fhir/StructureDefinition/Patient or http://hl7.org/fhir/StructureDefinition/RelatedPerson) "Who recorded the condition" "Individual who recorded the record and takes responsibility for its content."
* asserter 0..1 SU Reference(http://hl7.org/fhir/StructureDefinition/Practitioner or http://hl7.org/fhir/StructureDefinition/PractitionerRole or http://hl7.org/fhir/StructureDefinition/Patient or http://hl7.org/fhir/StructureDefinition/RelatedPerson) "Person who asserts this condition" "Individual who is making the condition statement."
* stage 0..0 BackboneElement "Stage/grade, usually assessed formally" "Clinical stage or grade of a condition. May include formal severity assessments."
* stage obeys con-1
...
* evidence 0..0 BackboneElement "Supporting evidence" "Supporting evidence / manifestations that are the basis of the Condition's verification status, such as evidence that confirmed or refuted the condition."
...
* evidence.code 0..0 SU CodeableConcept "Manifestation/symptom" "A manifestation or symptom that led to the recording of this condition."
...
* evidence.detail 0..0 SU Reference(http://hl7.org/fhir/StructureDefinition/Resource) "Supporting information found elsewhere" "Links to other relevant information, including pathology reports."
* evidence.detail ^condition[0] = "con-2"
* note 0..0 Annotation "Additional information about the Condition" "Additional information about the Condition. This is a general notes/comments entry  for description of the Condition, its diagnosis and prognosis."