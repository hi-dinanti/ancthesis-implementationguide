Profile: Observation-ANC-Gravida
Parent: $Observation
Id: observation-anc-gravida
Title: "Observation: Number of Pregnancies"
Description: "Observation representing the total number of pregnancies (gravida) reported by the patient. This data supports antenatal care assessments and maternal health evaluation."
...
* code[loinc].coding.code = #11996-6
* code[loinc].coding.display = "[#] Pregnancies"
...
* code[anc-custom].coding.display = "Number of pregnancies (gravida)"
...
* valueInteger 1..1 MS "Number of pregnancies (gravida)"
