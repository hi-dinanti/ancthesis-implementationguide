Profile: Observation-ANC-ProteinUrine
Parent: $Observation
Id: observation-anc-protein-urine
Title: "Observation: Protein in Urine"
Description: "Observation representing the protein concentration in urine, measured by test strip. This data supports antenatal care assessments for preeclampsia screening."
...
* category.coding contains
    vital-signs 1..1 MS
* category.coding[vital-signs].system = "http://terminology.hl7.org/CodeSystem/observation-category"
* category.coding[vital-signs].code = #vital-signs
* category.coding[vital-signs].display = "Vital Signs"
* code 1..1 MS
* code.coding 1..* MS
...
* code.coding[anc-custom].code = #ANC.B9.DE114
* code.coding[anc-custom].display = "Urine test conducted"
...
* value[x] undefined..1 MS SU Quantity or CodeableConcept 
* value[x] ^short = "Value type is quantity or CodeableConcept."
* valueQuantity 0..1 MS
* valueQuantity ^slicing.discriminator.type = #value
* valueQuantity ^slicing.discriminator.path = "code"
* valueQuantity ^slicing.rules = #closed
...
// Ideally this should be a value set - consideration to add valueset according to master data
...
* valueCodeableConcept.coding[positive].code = #LA6576-8
* valueCodeableConcept.coding[positive].display = "Positive"

* valueCodeableConcept.coding[negative].code = #LA6577-6
* valueCodeableConcept.coding[negative].display = "Negative"

* valueCodeableConcept.coding[one_plus].code = #LA11841-6
* valueCodeableConcept.coding[one_plus].display = "1+"

* valueCodeableConcept.coding[two_plus].code = #LA11842-4
* valueCodeableConcept.coding[two_plus].display = "2+"

* valueCodeableConcept.coding[three_plus].code = #LA11843-2
* valueCodeableConcept.coding[three_plus].display = "3+"

* valueCodeableConcept.coding[four_plus].code = #LA11844-0
* valueCodeableConcept.coding[four_plus].display = "4+"
