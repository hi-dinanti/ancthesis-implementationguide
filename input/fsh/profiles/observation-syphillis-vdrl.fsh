Profile: Observation-ANC-Syphillis-VDRL
Parent: $Observation
Id: observation-anc-syphillis-vdrl
Title: "Observation: Syphilis Screening (VDRL)"
Description: "Observation representing Syphilis (VDRL) screening results recorded during an antenatal care visit. This data supports maternal health assessments and infection control measures."
...
* code.coding[loinc].code = #14904-7
* code.coding[loinc].display = "Reagin Ab [Presence] in Specimen by VDRL"
* code.coding[anc-custom].system = "http://fhir.org/guides/who/anc-cds/CodeSystem/anc-custom-codes"
* code.coding[anc-custom].code = #ANC.B9.DE296
* code.coding[anc-custom].display = "Syphillis test conducted"
...
* valueCodeableConcept ^short = "Syphillos (VDRL) screening result"
* valueCodeableConcept.coding 1..*
* valueCodeableConcept.coding contains
    reactive 0..1 MS and
    non-reactive 0..1 MS
* valueCodeableConcept.coding[reactive].system = "http://snomed.info/sct"
* valueCodeableConcept.coding[reactive].code = #11214006
* valueCodeableConcept.coding[reactive].display = "Reactive"
* valueCodeableConcept.coding[non-reactive].system = "http://snomed.info/sct"
* valueCodeableConcept.coding[non-reactive].code = #131194007
* valueCodeableConcept.coding[non-reactive].display = "Non-Reactive"
