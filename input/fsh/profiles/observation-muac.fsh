Profile: Observation-ANC-LiLA
Parent: $Observation
Id: observation-anc-lila
Title: "Observation: Mid Upper Arm Circumference (LiLA)"
...
* category contains
    survey 1..1 MS
* category[exam].coding.system = "http://terminology.hl7.org/CodeSystem/observation-category"
* category[exam].coding.code = #exam
* category[exam].coding.display = "Exam"
...
* code.coding[anc-custom].system = "http://terminology.kemkes.go.id/CodeSystem/anc-custom-codes"
* code.coding[anc-custom].code = #ANC.SS.DE3
* code.coding[anc-custom].display = "Lingkar Lengan Atas (LILA)"
...
* value[x] undefined..1 MS SU valueQuantity 
* value[x] ^short = "Value type is decimal."
* valueQuantity 1..1 MS 
** valueQuantity.value ^short = "Mid upper arm circumference measurement"
