Profile: Observation-ANC-HIV
Parent: $Observation
Id: observation-anc-hiv
Title: "Observation: HIV Screening"
Description: "Observation representing HIV screening results recorded during an antenatal care visit. This data supports maternal health assessments and infection control measures."
...
* code.coding[loinc].code = #68961-2
* code.coding[loinc].display = "HIV 1 Ab [Presence] in Serum, Plasma or Blood by Rapid immunoassay"
* code.coding[anc-custom].system = "http://fhir.org/guides/who/anc-cds/CodeSystem/anc-custom-codes"
* code.coding[anc-custom].code = #ANC.B9.DE32
* code.coding[anc-custom].display = "HIV test"
* code ^short = "HIV Screening Test"
...
* valueCodeableConcept ^short = "Hepatitis B screening result"
