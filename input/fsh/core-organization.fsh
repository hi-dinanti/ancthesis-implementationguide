...
* identifier 0..0 SU Identifier "Identifies this organization  across multiple systems" "Identifier for the organization that is used to identify the organization across multiple disparate systems."
...
* type 0..0 SU CodeableConcept "Kind of organization" "The kind(s) of organization that this is."
...
* alias 0..0 string "A list of alternate names that the organization is known as, or was known as in the past" "A list of alternate names that the organization is known as, or was known as in the past."
...
* telecom 0..0 ContactPoint "A contact detail for the organization" "A contact detail for the organization."
* telecom obeys org-3
...
* address 0..0 https://fhir.kemkes.go.id/r4/StructureDefinition/Address "An address for the organization" "An address for the organization."
* address obeys org-2
...
* address.extension[geolocation].extension 2..0 BackboneElement
* partOf 0..1 SU Reference(http://hl7.org/fhir/StructureDefinition/Organization) "The organization of which this organization forms a part" "The organization of which this organization forms a part."
...
* contact 0..0 BackboneElement "Contact for the organization for a certain purpose" "Contact for the organization for a certain purpose."
...
* contact.telecom 0..0 ContactPoint "Contact details (telephone, email, etc.)  for a contact" "A contact detail (e.g. a telephone number or an email address) by which the party may be contacted."
...
* endpoint 0..0 Reference(http://hl7.org/fhir/StructureDefinition/Endpoint) "Technical endpoints providing access to services operated for the organization" "Technical endpoints providing access to services operated for the organization."
