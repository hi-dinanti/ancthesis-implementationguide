...
* instantiates 0..0 SU uri "Instantiates protocol or definition" "A protocol, guideline, orderset, or other definition that was adhered to in whole or in part by this event."
* partOf 0..0 SU Reference(http://hl7.org/fhir/StructureDefinition/MedicationAdministration or http://hl7.org/fhir/StructureDefinition/Procedure) "Part of referenced event" "A larger event of which this particular event is a component or step."
...
* statusReason 0..0 CodeableConcept "Reason administration not performed" "A code indicating why the administration was not performed."
...
* category 0..1 CodeableConcept "Type of medication usage" "Indicates where the medication is expected to be consumed or administered."
...
* context 0..1 Reference(http://hl7.org/fhir/StructureDefinition/Encounter or http://hl7.org/fhir/StructureDefinition/EpisodeOfCare) "Encounter or Episode of Care administered as part of" "The visit, admission, or other contact between patient and health care provider during which the medication administration was performed."
* supportingInformation 0..0 Reference(http://hl7.org/fhir/StructureDefinition/Resource) "Additional information to support administration" "Additional information (for example, patient height and weight) that supports the administration of the medication."
...
* performer 0..0 SU BackboneElement "Who performed the medication administration and what they did" "Indicates who or what performed the medication administration and how they were involved."
* performer.function 0..1 CodeableConcept "Type of performance" "Distinguishes the type of involvement of the performer in the medication administration."
...
* reasonCode 0..0 CodeableConcept "Reason administration performed" "A code indicating why the medication was given."
...
* request 0..1 Reference(http://hl7.org/fhir/StructureDefinition/MedicationRequest) "Request administration performed against" "The original request, instruction or authority to perform the administration."
...
* device 0..0 Reference(http://hl7.org/fhir/StructureDefinition/Device) "Device used to administer" "The device used in administering the medication to the patient.  For example, a particular infusion pump."
* note 0..0 Annotation "Information about the administration" "Extra information about the medication administration that is not conveyed by the other attributes."
* dosage 0..1 BackboneElement "Details of how medication was taken" "Describes the medication dosage information details e.g. dose, rate, site, route, etc."
* dosage obeys mad-1
* dosage.text 0..1 string "Free text dosage instructions e.g. SIG" "Free text dosage can be used for cases where the dosage administered is too complex to code. When coded dosage is present, the free text dosage may still be present for display to humans.\r\rThe dosage instructions should reflect the dosage of the medication that was administered."
* dosage.site 0..1 CodeableConcept "Body site administered to" "A coded specification of the anatomic site where the medication first entered the body.  For example, \"left arm\"."
...
* dosage.route 0..1 CodeableConcept "Path of substance into body" "A code specifying the route or physiological path of administration of a therapeutic agent into or onto the patient.  For example, topical, intravenous, etc."
...
* dosage.method 0..1 CodeableConcept "How drug was administered" "A coded value indicating the method by which the medication is intended to be or was introduced into or on the body.  This attribute will most often NOT be populated.  It is most commonly used for injections.  For example, Slow Push, Deep IV."
...
* dosage.dose 0..1 http://hl7.org/fhir/StructureDefinition/SimpleQuantity "Amount of medication per dose" "The amount of the medication given at one administration event.   Use this value when the administration is essentially an instantaneous event such as a swallowing a tablet or giving an injection."
...
* dosage.rate[x] 0..1 Ratio or http://hl7.org/fhir/StructureDefinition/SimpleQuantity "Dose quantity per unit of time" "Identifies the speed with which the medication was or will be introduced into the patient.  Typically, the rate for an infusion e.g. 100 ml per 1 hour or 100 ml/hr.  May also be expressed as a rate per unit of time, e.g. 500 ml per 2 hours.  Other examples:  200 mcg/min or 200 mcg/1 minute; 1 liter/8 hours."
...
* eventHistory 0..0 Reference(http://hl7.org/fhir/StructureDefinition/Provenance) "A list of events of interest in the lifecycle" "A summary of the events of interest that have occurred, such as when the administration was verified."
