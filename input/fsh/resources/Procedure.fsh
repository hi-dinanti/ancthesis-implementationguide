...
* basedOn undefined..undefined SU Reference(http://hl7.org/fhir/StructureDefinition/CarePlan or http://hl7.org/fhir/StructureDefinition/ServiceRequest) "A request for this procedure" "A reference to a resource that contains details of the request for this procedure."
* basedOn ^alias[0] = "fulfills"
* partOf undefined..undefined SU Reference(http://hl7.org/fhir/StructureDefinition/Procedure or http://hl7.org/fhir/StructureDefinition/Observation or http://hl7.org/fhir/StructureDefinition/MedicationAdministration) "Part of referenced event" "A larger event of which this particular procedure is a component or step."
...
* code undefined..1 SU CodeableConcept "Identification of the procedure" "The specific procedure that is performed. Use text if the exact nature of the procedure cannot be coded (e.g. \"Laparoscopic Appendectomy\")."
...
* encounter undefined..1 SU Reference(http://hl7.org/fhir/StructureDefinition/Encounter) "Encounter created as part of" "The Encounter during which this Procedure was created or performed or to which the creation of this record is tightly associated."
...
* recorder undefined..1 SU Reference(http://hl7.org/fhir/StructureDefinition/Patient or http://hl7.org/fhir/StructureDefinition/RelatedPerson or http://hl7.org/fhir/StructureDefinition/Practitioner or http://hl7.org/fhir/StructureDefinition/PractitionerRole) "Who recorded the procedure" "Individual who recorded the record and takes responsibility for its content."
* asserter undefined..1 SU Reference(http://hl7.org/fhir/StructureDefinition/Patient or http://hl7.org/fhir/StructureDefinition/RelatedPerson or http://hl7.org/fhir/StructureDefinition/Practitioner or http://hl7.org/fhir/StructureDefinition/PractitionerRole) "Person who asserts this procedure" "Individual who is making the procedure statement."
...
* performer.onBehalfOf undefined..1 Reference(http://hl7.org/fhir/StructureDefinition/Organization) "Organization the device or practitioner was acting for" "The organization the device or practitioner was acting on behalf of."
...
* location undefined..1 SU Reference(http://hl7.org/fhir/StructureDefinition/Location) "Where the procedure happened" "The location where the procedure actually happened.  E.g. a newborn at home, a tracheostomy at a restaurant."
...
* report undefined..undefined Reference(http://hl7.org/fhir/StructureDefinition/DiagnosticReport or http://hl7.org/fhir/StructureDefinition/DocumentReference or http://hl7.org/fhir/StructureDefinition/Composition) "Any report resulting from the procedure" "This could be a histology result, pathology report, surgical report, etc."
...
* complicationDetail undefined..undefined Reference(http://hl7.org/fhir/StructureDefinition/Condition) "A condition that is a result of the procedure" "Any complications that occurred during the procedure, or in the immediate post-performance period."
...
* usedReference undefined..undefined Reference(http://hl7.org/fhir/StructureDefinition/Device or http://hl7.org/fhir/StructureDefinition/Medication or http://hl7.org/fhir/StructureDefinition/Substance) "Items used during procedure" "Identifies medications, devices and any other substance used as part of the procedure."
