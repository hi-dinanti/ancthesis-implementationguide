Instance: Gravida-Example
InstanceOf: ANCGravida
Title: "Gravida Example (Observation)"
Description: "Observation recording the number of pregnancies (gravida)."
Usage: #example
...
* code.coding[0].display = "[#] Pregnancies"
* code.coding[1].system = "http://fhir.org/guides/who/anc-cds/CodeSystem/anc-custom-codes"
* code.coding[1].code = #ANC.B6.DE24
* code.coding[1].display = "Number of pregnancies (gravida)"
