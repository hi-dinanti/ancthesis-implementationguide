...
* ^meta.lastUpdated = "2025-02-11T05:35:38.6764871+00:00"
...
* identifier 0..0 SU Identifier "Business identifier for this medication" "Business identifier for this medication."
...
* status 0..1 ?! SU code "active | inactive | entered-in-error" "A code to indicate if the medication is in active use."
...
* manufacturer 0..1 SU Reference(http://hl7.org/fhir/StructureDefinition/Organization) "Manufacturer of the item" "Describes the details of the manufacturer of the medication product.  This is not intended to represent the distributor of a medication product."
* form 0..1 CodeableConcept "powder | tablets | capsule +" "Describes the form of the item.  Powder; tablets; capsule."
...
* ingredient 0..0 BackboneElement "Active or inactive ingredient" "Identifies a particular constituent of interest in the product."
...
* ingredient.strength 0..1 Ratio "Quantity of ingredient present" "Specifies how many (or how much) of the items there are in this Medication.  For example, 250 mg per tablet.  This is expressed as a ratio where the numerator is 250mg and the denominator is 1 tablet."
* batch 0..1 BackboneElement "Details about packaged medications" "Information that only applies to packages (not products)."
* batch.lotNumber 0..1 string "Identifier assigned to batch" "The assigned lot number of a batch of the specified product."
* batch.expirationDate 0..1 dateTime "When batch will expire" "When this specific batch of product will expire."