...
* ^meta.lastUpdated = "2025-02-11T05:32:58.0231361+00:00"
...
* identifier 0..0 SU Identifier "External Identifiers for this procedure" "Business identifiers assigned to this procedure by the performer or other systems which remain constant as the resource is updated and is propagated from server to server."
...
* instantiatesCanonical 0..0 SU Canonical(http://hl7.org/fhir/StructureDefinition/PlanDefinition or http://hl7.org/fhir/StructureDefinition/ActivityDefinition or http://hl7.org/fhir/StructureDefinition/Measure or http://hl7.org/fhir/StructureDefinition/OperationDefinition or http://hl7.org/fhir/StructureDefinition/Questionnaire) "Instantiates FHIR protocol or definition" "The URL pointing to a FHIR-defined protocol, guideline, order set or other definition that is adhered to in whole or in part by this Procedure."
* instantiatesUri 0..0 SU uri "Instantiates external protocol or definition" "The URL pointing to an externally maintained protocol, guideline, order set or other definition that is adhered to in whole or in part by this Procedure."
* instantiatesUri ^comment = "This might be an HTML page, PDF, etc. or could just be a non-resolvable URI identifier."
* basedOn 0..0 SU Reference(http://hl7.org/fhir/StructureDefinition/CarePlan or http://hl7.org/fhir/StructureDefinition/ServiceRequest) "A request for this procedure" "A reference to a resource that contains details of the request for this procedure."
* basedOn ^alias[0] = "fulfills"
* partOf 0..0 SU Reference(http://hl7.org/fhir/StructureDefinition/Procedure or http://hl7.org/fhir/StructureDefinition/Observation or http://hl7.org/fhir/StructureDefinition/MedicationAdministration) "Part of referenced event" "A larger event of which this particular procedure is a component or step."
...
* statusReason 0..1 SU CodeableConcept "Reason for current status" "Captures the reason for the current state of the procedure."
...
* category 0..1 SU CodeableConcept "Classification of the procedure" "A code that classifies the procedure for searching, sorting and display purposes (e.g. \"Surgical Procedure\")."
...
* code 0..1 SU CodeableConcept "Identification of the procedure" "The specific procedure that is performed. Use text if the exact nature of the procedure cannot be coded (e.g. \"Laparoscopic Appendectomy\")."
...
* subject 1..1 SU Reference(http://hl7.org/fhir/StructureDefinition/Patient or http://hl7.org/fhir/StructureDefinition/Group) "Who the procedure was performed on" "The person, animal or group on which the procedure was performed."
* subject ^alias[0] = "patient"
* encounter 0..1 SU Reference(http://hl7.org/fhir/StructureDefinition/Encounter) "Encounter created as part of" "The Encounter during which this Procedure was created or performed or to which the creation of this record is tightly associated."
...
* performed[x] 0..1 SU dateTime or Period or string or Age or Range "When the procedure was performed" "Estimated or actual date, date-time, period, or age when the procedure was performed.  Allows a period to support complex procedures that span more than one date, and also allows for the length of the procedure to be captured."
* performed[x] ^comment = "Age is generally used when the patient reports an age at which the procedure was performed. Range is generally used when the patient reports an age range when the procedure was performed, such as sometime between 20-25 years old.  dateTime supports a range of precision due to some procedures being reported as past procedures that might not have millisecond precision while other procedures performed and documented during the encounter might have more precise UTC timestamps with timezone."
* recorder 0..1 SU Reference(http://hl7.org/fhir/StructureDefinition/Patient or http://hl7.org/fhir/StructureDefinition/RelatedPerson or http://hl7.org/fhir/StructureDefinition/Practitioner or http://hl7.org/fhir/StructureDefinition/PractitionerRole) "Who recorded the procedure" "Individual who recorded the record and takes responsibility for its content."
* asserter 0..1 SU Reference(http://hl7.org/fhir/StructureDefinition/Patient or http://hl7.org/fhir/StructureDefinition/RelatedPerson or http://hl7.org/fhir/StructureDefinition/Practitioner or http://hl7.org/fhir/StructureDefinition/PractitionerRole) "Person who asserts this procedure" "Individual who is making the procedure statement."
* performer 0..0 SU BackboneElement "The people who performed the procedure" "Limited to \"real\" people rather than equipment."
* performer.function 0..1 SU CodeableConcept "Type of performance" "Distinguishes the type of involvement of the performer in the procedure. For example, surgeon, anaesthetist, endoscopist."
...
* performer.actor 1..1 SU Reference(http://hl7.org/fhir/StructureDefinition/Practitioner or http://hl7.org/fhir/StructureDefinition/PractitionerRole or http://hl7.org/fhir/StructureDefinition/Organization or http://hl7.org/fhir/StructureDefinition/Patient or http://hl7.org/fhir/StructureDefinition/RelatedPerson or http://hl7.org/fhir/StructureDefinition/Device) "The reference to the practitioner" "The practitioner who was involved in the procedure."
* performer.actor ^requirements = "A reference to Device supports use cases, such as pacemakers."
* performer.onBehalfOf 0..1 Reference(http://hl7.org/fhir/StructureDefinition/Organization) "Organization the device or practitioner was acting for" "The organization the device or practitioner was acting on behalf of."
...
* location 0..1 SU Reference(http://hl7.org/fhir/StructureDefinition/Location) "Where the procedure happened" "The location where the procedure actually happened.  E.g. a newborn at home, a tracheostomy at a restaurant."
* location ^requirements = "Ties a procedure to where the records are likely kept."
* reasonCode 0..0 SU CodeableConcept "Coded reason procedure performed" "The coded reason why the procedure was performed. This may be a coded entity of some type, or may simply be present as text."
...
* reasonReference 0..0 SU Reference(http://hl7.org/fhir/StructureDefinition/Condition or http://hl7.org/fhir/StructureDefinition/Observation or http://hl7.org/fhir/StructureDefinition/Procedure or http://hl7.org/fhir/StructureDefinition/DiagnosticReport or http://hl7.org/fhir/StructureDefinition/DocumentReference) "The justification that the procedure was performed" "The justification of why the procedure was performed."
...
* bodySite 0..0 SU CodeableConcept "Target body sites" "Detailed and structured anatomical location information. Multiple locations are allowed - e.g. multiple punch biopsies of a lesion."
...
* outcome 0..1 SU CodeableConcept "The result of procedure" "The outcome of the procedure - did it resolve the reasons for the procedure being performed?"
...
* outcome ^binding.extension.url = "http://hl7.org/fhir/StructureDefinition/elementdefinition-bindingName"
...
* report 0..0 Reference(http://hl7.org/fhir/StructureDefinition/DiagnosticReport or http://hl7.org/fhir/StructureDefinition/DocumentReference or http://hl7.org/fhir/StructureDefinition/Composition) "Any report resulting from the procedure" "This could be a histology result, pathology report, surgical report, etc."
...
* complication 0..0 CodeableConcept "Complication following the procedure" "Any complications that occurred during the procedure, or in the immediate post-performance period. These are generally tracked separately from the notes, which will typically describe the procedure itself rather than any 'post procedure' issues."
...
* complication ^binding.extension.url = "http://hl7.org/fhir/StructureDefinition/elementdefinition-bindingName"
...
* complicationDetail 0..0 Reference(http://hl7.org/fhir/StructureDefinition/Condition) "A condition that is a result of the procedure" "Any complications that occurred during the procedure, or in the immediate post-performance period."
...
* followUp 0..0 CodeableConcept "Instructions for follow up" "If the procedure required specific follow up - e.g. removal of sutures. The follow up may be represented as a simple note or could potentially be more complex, in which case the CarePlan resource can be used."
* followUp from http://hl7.org/fhir/ValueSet/procedure-followup (example)
* followUp ^binding.extension.url = "http://hl7.org/fhir/StructureDefinition/elementdefinition-bindingName"
...
* note 0..0 Annotation "Additional information about the procedure" "Any other notes and comments about the procedure."
* focalDevice 0..0 BackboneElement "Manipulated, implanted, or removed device" "A device that is implanted, removed or otherwise manipulated (calibration, battery replacement, fitting a prosthesis, attaching a wound-vac, etc.) as a focal portion of the Procedure."
* focalDevice.action 0..1 CodeableConcept "Kind of change to device" "The kind of change that happened to the device during the procedure."
* focalDevice.action from http://hl7.org/fhir/ValueSet/device-action (preferred)
* focalDevice.action ^binding.extension.url = "http://hl7.org/fhir/StructureDefinition/elementdefinition-bindingName"
...
* focalDevice.manipulated 1..1 Reference(http://hl7.org/fhir/StructureDefinition/Device) "Device that was changed" "The device that was manipulated (changed) during the procedure."
* usedReference 0..0 Reference(http://hl7.org/fhir/StructureDefinition/Device or http://hl7.org/fhir/StructureDefinition/Medication or http://hl7.org/fhir/StructureDefinition/Substance) "Items used during procedure" "Identifies medications, devices and any other substance used as part of the procedure."
...
* usedCode 0..0 CodeableConcept "Coded items used during the procedure" "Identifies coded items that were used as part of the procedure."
...
* usedCode ^binding.extension.url = "http://hl7.org/fhir/StructureDefinition/elementdefinition-bindingName"
