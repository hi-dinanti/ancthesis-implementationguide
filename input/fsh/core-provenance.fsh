...
* occurred[x] 0..1 Period or dateTime "When the activity occurred" "The period during which the activity occurred."
...
* policy 0..0 uri "Policy or plan the activity was defined by" "Policy or plan the activity was defined by. Typically, a single activity may have multiple applicable policy documents, such as patient consent, guarantor funding, etc."
...
* location 0..1 Reference(http://hl7.org/fhir/StructureDefinition/Location) "Where the activity occurred, if relevant" "Where the activity occurred, if relevant."
* reason 0..0 CodeableConcept "Reason the activity is occurring" "The reason that the activity was taking place."
...
* activity 0..1 CodeableConcept "Activity that occurred" "An activity is something that occurs over a period of time and acts upon or with entities; it may include consuming, processing, transforming, modifying, relocating, using, or generating entities."
...
* agent 1..0 BackboneElement "Actor involved" "An actor taking a role in an activity  for which it can be assigned some degree of responsibility for the activity taking place."
...
* agent.type 0..1 SU CodeableConcept "How the agent participated" "The participation the agent had with respect to the activity."
...
* agent.role 0..0 CodeableConcept "What the agents role was" "The function of the agent with respect to the activity. The security role enabling the agent with respect to the activity."
...
* agent.onBehalfOf 0..1 Reference(http://hl7.org/fhir/StructureDefinition/Practitioner or http://hl7.org/fhir/StructureDefinition/PractitionerRole or http://hl7.org/fhir/StructureDefinition/RelatedPerson or http://hl7.org/fhir/StructureDefinition/Patient or http://hl7.org/fhir/StructureDefinition/Device or http://hl7.org/fhir/StructureDefinition/Organization) "Who the agent is representing" "The individual, device, or organization for whom the change was made."
* agent.onBehalfOf ^comment = "onBehalfOfIdentity should be used when the agent is not a Resource type."
* entity 0..0 BackboneElement "An entity used in this activity" "An entity used in this activity."
...
* signature 0..0 Signature "Signature on target" "A digital signature on the target Reference(s). The signer should match a Provenance.agent. The purpose of the signature is indicated."