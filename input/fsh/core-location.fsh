...
* ^meta.lastUpdated = "2025-02-11T05:35:26.5015175+00:00"
...
* identifier 0..0 SU Identifier "Unique code or number identifying the location to its users" "Unique code or number identifying the location to its users."
* identifier ^requirements = "Organization label locations in registries, need to keep track of those."
* status 0..1 ?! SU code "active | suspended | inactive" "The status property covers the general availability of the resource, not the current value which may be covered by the operationStatus, or by a schedule/slots if they are configured for the location."
...
* name 0..1 SU string "Name of the location as used by humans" "Name of the location as used by humans. Does not need to be unique."
...
* alias 0..0 string "A list of alternate names that the location is known as, or was known as, in the past" "A list of alternate names that the location is known as, or was known as, in the past."
...
* description 0..1 SU string "Additional details about the location that could be displayed as further information to identify the location beyond its name" "Description of the Location, which helps in finding or referencing the place."
* description ^requirements = "Humans need additional information to verify a correct location has been identified."
* mode 0..1 SU code "instance | kind" "Indicates whether a resource instance represents a specific location or a class of locations."
...
* type 0..0 SU CodeableConcept "Type of function performed" "Indicates the type of function performed at the location."
...
* telecom 0..0 ContactPoint "Contact details of the location" "The contact details of communication devices available at the location. This can include phone numbers, fax numbers, mobile numbers, email addresses and web sites."
* address 0..1 https://fhir.kemkes.go.id/r4/StructureDefinition/Address "Physical location" "Physical location."
...
* physicalType 0..1 SU CodeableConcept "Physical form of the location" "Physical form of the location, e.g. building, room, vehicle, road."
...
* physicalType ^binding.extension.url = "http://hl7.org/fhir/StructureDefinition/elementdefinition-bindingName"
* physicalType ^binding.extension.valueString = "PhysicalType"
* physicalType ^binding.description = "Physical form of the location."
* position 0..1 BackboneElement "The absolute geographic location" "The absolute geographic location of the Location, expressed using the WGS84 datum (This is the same co-ordinate system used in KML)."
...
* position.altitude 0..1 decimal "Altitude with WGS84 datum" "Altitude. The value domain and the interpretation are the same as for the text of the altitude element in KML (see notes below)."
* managingOrganization 0..1 SU Reference(http://hl7.org/fhir/StructureDefinition/Organization) "Organization responsible for provisioning and upkeep" "The organization responsible for the provisioning and upkeep of the location."
...
* partOf 0..1 Reference(http://hl7.org/fhir/StructureDefinition/Location) "Another Location this one is physically a part of" "Another Location of which this Location is physically a part of."
...
* hoursOfOperation 0..0 BackboneElement "What days/times during a week is this location usually open" "What days/times during a week is this location usually open."
...
* hoursOfOperation.daysOfWeek 0..0 code "mon | tue | wed | thu | fri | sat | sun" "Indicates which days of the week are available between the start and end Times."
* hoursOfOperation.daysOfWeek from http://hl7.org/fhir/ValueSet/days-of-week|4.0.1 (required)
* hoursOfOperation.daysOfWeek ^binding.extension.url = "http://hl7.org/fhir/StructureDefinition/elementdefinition-bindingName"
...
* hoursOfOperation.allDay 0..1 boolean "The Location is open all day" "The Location is open all day."
* hoursOfOperation.openingTime 0..1 time "Time that the Location opens" "Time that the Location opens."
* hoursOfOperation.closingTime 0..1 time "Time that the Location closes" "Time that the Location closes."
* availabilityExceptions 0..1 string "Description of availability exceptions" "A description of when the locations opening ours are different to normal, e.g. public holiday availability. Succinctly describing all possible exceptions to normal site availability as detailed in the opening hours Times."
* endpoint 0..0 Reference(http://hl7.org/fhir/StructureDefinition/Endpoint) "Technical endpoints providing access to services operated for the location" "Technical endpoints providing access to services operated for the location."
