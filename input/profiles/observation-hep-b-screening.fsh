Profile: Observation-ANC-Hepatitis-B
Parent: Observation
Id: observation-anc-hepatitis-b
Title: "Observation: Hepatitis B Screening"
Description: "Observation representing Hepatitis B screening results recorded during an antenatal care visit. This data supports maternal health assessments and infection control measures."
...
* code.coding[loinc].display = "Hepatitis B virus surface antigen [Presence] in Serum or Plasma"
* code.coding[anc-custom].system = "http://fhir.org/guides/who/anc-cds/CodeSystem/anc-custom-codes"
* code.coding[anc-custom].code = #ANC.B9.DE200
* code.coding[anc-custom].display = "Hepatitis B screening test conducted"
...
* valueCodeableConcept.coding contains
    positive 0..1 MS and
    negative 0..1 MS
* valueCodeableConcept.coding[positive].system = "http://snomed.info/sct"
* valueCodeableConcept.coding[positive].code = #11214006
* valueCodeableConcept.coding[positive].display = "Reactive"
* valueCodeableConcept.coding[negative].system = "http://snomed.info/sct"
* valueCodeableConcept.coding[negative].code = #131194007
* valueCodeableConcept.coding[negative].display = "Non-Reactive"
