...
Profile: Observation-ANC-Abortus
Parent: Observation
Id: observation-anc-abortus
Title: "Observation: Number of Miscarriages and/or Abortions"
Description: "Observation representing the number of miscarriages and/or abortions as reported in a survey. This data point is collected to support antenatal care assessments."
...
* category contains
    survey 1..1 MS
* category[survey].coding.system = "http://terminology.hl7.org/CodeSystem/observation-category"
* category[survey].coding.code = #survey
* category[survey].coding.display = "Survey"
...
* code contains
    loinc 1..1 MS and
    anc-custom 0..1 MS
* code[loinc].coding.system = "http://loinc.org"
* code[loinc].coding.code = #69043-8
* code[loinc].coding.display = "Other pregnancy outcomes #"
* code[anc-custom].coding.system = "http://fhir.org/guides/who/anc-cds/CodeSystem/anc-custom-codes"
* code[anc-custom].coding.code = #ANC.B6.DE25
* code[anc-custom].coding.display = "Number of miscarriages and/or abortions"
...
* value[x] undefined..1 MS SU integer 
* value[x] ^short = "Value type is integer."
* valueInteger 1..1 MS "Number of miscarriages and/or abortions"
