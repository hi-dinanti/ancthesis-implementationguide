...
Profile: Observation-ANC-HPHT
Parent: Observation
Id: observation-anc-hpht
...
* code.coding[anc-custom].code = #ANC.B6.DE14
* code.coding[anc-custom].display = "Last menstrual period (LMP) date"
* code ^short = "LMP start date"
...
* value[x] undefined..1 MS SU dateTime 
* value[x] ^short = "Value type is dateTime."
* valueDateTime 1..1 MS
* valueDateTime ^short = "Date of last menstrual period (LMP)"
