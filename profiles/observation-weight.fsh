...
Profile: Observation-ANC-Weight
Parent: Observation
Id: observation-anc-weight
...
* code[loinc].coding.code = #29463-7
* code[loinc].coding.display = "Body height"
* code[anc-custom].coding.system = "http://fhir.org/guides/who/anc-cds/CodeSystem/anc-custom-codes"
* code[anc-custom].coding.code = #ANC.B8.DE3
* code[anc-custom].coding.display = "Current weight"
