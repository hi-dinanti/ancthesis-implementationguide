...
Profile: Observation-ANC-Blood-Pressure
Parent: Observation
Id: observation-anc-blood-pressure
Title: "Observation: Blood Pressure Measurement"
...
* status contains
    registered 1..1 MS and
    preliminary 1..1 MS and
    final 1..1 MS and
    amended 1..1 MS
...
* code.coding contains
    systolic 1..1 MS and
    diastolic 1..1 MS
* code.coding[systolic].system = "http://loinc.org"
* code.coding[systolic].code = #8480-6
* code.coding[systolic].display = "Systolic blood pressure"
* code.coding[systolic] from http://fhir.org/guides/who/anc-cds/CodeSystem/anc-custom-codes (preferred)
* code.coding[systolic].code = #ANC.B8.DE17
* code.coding[systolic].display = "Systolic blood pressure"

* code.coding[diastolic].system = "http://loinc.org"
* code.coding[diastolic].code = #8462-4
* code.coding[diastolic].display = "Diastolic blood pressure"
* code.coding[diastolic] from http://fhir.org/guides/who/anc-cds/CodeSystem/anc-custom-codes (preferred)
* code.coding[diastolic].code = #ANC.B8.DE19
* code.coding[diastolic].display = "Diastolic blood pressure"
...
* valueQuantity contains
    systolicValue 1..1 MS and
    diastolicValue 1..1 MS
* valueQuantity[systolicValue].value 1..1 MS
* valueQuantity[systolicValue].unit = "mm[Hg]"
* valueQuantity[systolicValue].system = "http://unitsofmeasure.org"
* valueQuantity[systolicValue].code = #mm[Hg]

* valueQuantity[diastolicValue].value 1..1 MS
* valueQuantity[diastolicValue].unit = "mm[Hg]"
* valueQuantity[diastolicValue].system = "http://unitsofmeasure.org"
* valueQuantity[diastolicValue].code = #mm[Hg]
