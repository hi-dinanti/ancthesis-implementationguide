...
Profile: Observation-ANC-Rhesus
Parent: Observation
Id: observation-anc-rhesus
Title: "Observation: Rhesus type in blood examination"
Description: "Observation representing Rh factor in blood recorded during an antenatal care visit. This data supports maternal health assessment as part of the Indonesian minimum 10T exam."
...
* code.coding[loinc].code = #10331-7
* code.coding[loinc].display = "Rh [Type] in Blood"
* code.coding[anc-custom].system = "http://fhir.org/guides/who/anc-cds/CodeSystem/anc-custom-codes"
* code.coding[anc-custom].code = #ANC.B9.DE29
* code.coding[anc-custom].display = "Rh factor"
* code ^short = "Rh factor"
...
* valueCodeableConcept ^binding.description = "Rhesus type in blood"
