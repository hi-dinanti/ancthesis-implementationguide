...
* . ^alias[0] = "Visit"
* identifier 1..1 SU Identifier "Identifier(s) by which this encounter is known" "Identifier(s) by which this encounter is known. The transmission of ANC visit data through the Encounter.identifier element is carried out for each ANC/pregnancy visit by providing information on whether the visit falls into the category of K1 akses, K1 murni, K2 visit, and so on."
* identifier.system undefined..undefined BackboneElement "http://terminology.kemkes.go.id/CodeSystem/episodeofcare/ANC" "Establishes the namespace for tracking different phases of antenatal care (ANC) episodes. This identifier is used to categorize and manage ANC services throughout pregnancy,"
* identifier.value undefined..undefined BackboneElement "K1A | K1M | K2 | K3 | K4 | K5 | K6" "K1A | K1M | K2 | K3 | K4 | K5 | K6"
* identifier.value ^comment = "K1A Kunjungan K1 akses | K1M Kunjungan K1 murni | K2 Kunjungan K2 | K3 Kunjungan K3 | K4 Kunjungan K4 | K5 Kunjungan K5 | K6 Kunjungan K6"
* identifier.value ^requirements = "To track the patient antenatal care visit in accordance to national regulation."
