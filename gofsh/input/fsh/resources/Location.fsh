...
* managingOrganization undefined..1 SU Reference(http://hl7.org/fhir/StructureDefinition/Organization) "Organization responsible for provisioning and upkeep" "The organization responsible for the provisioning and upkeep of the location."
...
* partOf undefined..1 Reference(http://hl7.org/fhir/StructureDefinition/Location) "Another Location this one is physically a part of" "Another Location of which this Location is physically a part of."
...
* endpoint undefined..undefined Reference(http://hl7.org/fhir/StructureDefinition/Endpoint) "Technical endpoints providing access to services operated for the location" "Technical endpoints providing access to services operated for the location."
