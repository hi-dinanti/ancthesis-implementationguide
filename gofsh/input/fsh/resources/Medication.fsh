...
* manufacturer undefined..1 SU Reference(http://hl7.org/fhir/StructureDefinition/Organization) "Manufacturer of the item" "Describes the details of the manufacturer of the medication product.  This is not intended to represent the distributor of a medication product."
