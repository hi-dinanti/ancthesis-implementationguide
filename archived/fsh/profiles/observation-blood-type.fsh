Profile: Observation-ANC-Random-Blood-Sugar
Parent: $Observation
Id: observation-anc-random-blood-sugar
Title: "Observation: Random Blood Sugar Measurement"
Description: "Observation representing blood type (ABO and Rh factor) recorded during an antenatal care visit. This data supports maternal health assessment as part of the Indonesian minimum 10T exam."
...
* code.coding[loinc].code = #883-9
* code.coding[loinc].display = "ABO group [Type] in Blood"
* code.coding[anc-custom].system = "http://fhir.org/guides/who/anc-cds/CodeSystem/anc-custom-codes"
* code.coding[anc-custom].code = #ANC.B9.DE24
* code.coding[anc-custom].display = "Blood type"
* code ^short = "Blood Glucose Level"
...
* value[x] undefined..1 MS SU CodeableConcept 
* value[x] ^short = "Value type is CodeableConcept."
* valueCodeableConcept 1..1 MS
* valueCodeableConcept ^binding.strength = #required
* valueCodeableConcept ^binding.description = "ABO Blood Group Types"
...
* valueCodeableConcept.coding contains
    ...
    groupO 0..1 MS and
    groupAB 0..1 MS
* valueCodeableConcept.coding[groupA].code = #LA19710-5
* valueCodeableConcept.coding[groupA].display = "Group A"
* valueCodeableConcept.coding[groupB].code = #LA19709-7
* valueCodeableConcept.coding[groupB].display = "Group B"
* valueCodeableConcept.coding[groupO].code = #LA19708-9
* valueCodeableConcept.coding[groupO].display = "Group O"
* valueCodeableConcept.coding[groupAB].code = #LA28449-9
* valueCodeableConcept.coding[groupAB].display = "Group AB"
