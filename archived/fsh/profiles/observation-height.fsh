Profile: Observation-ANC-Height
Parent: $Observation
Id: observation-anc-height
...
* code[anc-custom].coding.code = #ANC.B8.DE1
* code[anc-custom].coding.display = "Height"
