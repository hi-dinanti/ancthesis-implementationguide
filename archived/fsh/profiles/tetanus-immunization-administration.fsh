Profile: Immunization-ANC-Administration
Parent: $Immunization
Id: Immunization
...
* vaccineCode ^slicing.discriminator.path = "coding.system"
* vaccineCode ^slicing.rules = #closed
* vaccineCode contains Td 0..1 MS
* vaccineCode[Td].coding.system = "http://sys-ids.kemkes.go.id/kfa"
* vaccineCode[Td].coding.code = #VG139
* vaccineCode[Td].coding.display = "Td"
...
* primarySource 1..1 SU boolean "Indicates context the data was recorded in" "An indication that the content of the record is based on information from the person who administered the vaccine. This reflects the context under which the data was originally recorded."
* primarySource ^slicing.discriminator.type = #value
* primarySource ^slicing.discriminator.path = "$this"
* primarySource ^slicing.rules = #closed
* primarySource contains TrueSource 1..1 MS
* primarySource[TrueSource] = true
