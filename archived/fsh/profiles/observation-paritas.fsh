Profile: Observation-ANC-Parity
Parent: $Observation
Id: observation-anc-parity
Title: "Observation: Parity"
Description: "Observation representing the number of times a woman has given birth to a viable offspring (parity). This data supports antenatal care assessments and obstetric history documentation."
...
* code.coding[loinc].code = #11977-6
* code.coding[loinc].display = "[#] Parity"
* code.coding[anc-custom].system = "http://fhir.org/guides/who/anc-cds/CodeSystem/anc-custom-codes"
* code.coding[anc-custom].code = #ANC.B6.DE32
* code.coding[anc-custom].display = "Parity"
...
* valueInteger 1..1 MS
* valueInteger ^short = "Number of times the woman has given birth to a viable infant (Parity)"
