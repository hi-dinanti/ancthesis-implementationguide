Profile: Observation-ANC-BloodSugar
Parent: $Observation
...
* code.coding[anc-custom].code = #ANC.B9.DE159
* code.coding[anc-custom].display = "Blood glucose test conducted"
...
* valueQuantity ^short = "Blood glucose concentration"
...
* valueQuantity ^binding.description = "Units of measurement for blood glucose levels."
