CodeSystem: SATUSEHATANCCustomCode
Id: SATUSEHATANCCustomCode
Title: "SATUSEHAT ANC Custom Codes"
...
* #ANC.SS.DE27 "Pemeriskaan Fisik Sklera"
...
* #ANC.SS.DE1 "Taksiran Berat Janin"
...
* #ANC.SS.DE41 "Letak Janin USG"
* #ANC.SS.DE45 "Berat janin USG"
* #ANC.SS.DE44 "Femur Length (FL) USG"

CodeSystem: SATUSEHATKFA
Id: SATUSEHATKFA
Title: "KFA Codes"
Description: "Set of KFA codes representing SATUSEHAT concepts used in the implementation guide"
* ^status = #active
* ^experimental = false
* ^caseSensitive = true
* ^url = http://sys-ids.kemkes.go.id/kfa
* #VG139 "Td"

CodeSystem: SATUSEHATClinicalTerm
Id: SATUSEHATClinicalTerm
Title: "SATUSEHAT Clinical Term"
Description: "Set of KFA codes representing SATUSEHAT concepts used in the implementation guide"
* ^status = #active
* ^experimental = false
* ^caseSensitive = true
...
CodeSystem: SATUSEHATImmunizationCode
Id: SATUSEHATImmunizationCode
Title: "SATUSEHAT Immunization Codes"
Description: "Set of immunization codes representing SATUSEHAT concepts used in the implementation guide"
* ^status = #active
* ^experimental = false
* ^caseSensitive = true
* ^url = http://terminology.kemkes.go.id/CodeSystem/immunization-reason
