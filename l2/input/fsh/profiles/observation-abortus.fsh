...
Parent: $Observation
Id: ANCAbortus
Title: "Abortus (Observation)" 
Description: "Observation representing obstetric [GPA#] status of antenatal care patient as reported in a survey. Abortus represent the number of miscarriages and/or abortions."
...
* code.coding.code = #69043-8 (exactly)
* code.coding.display = "Other pregnancy outcomes #"
* value[x] only integer
* value[x] ^comment = "Value only integer"
* valueInteger 1..1
