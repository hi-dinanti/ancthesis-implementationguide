...
Parent: $Observation
Id: ANCParitas
Title: "Paritas (Observation)" 
Description: "Observation representing obstetric [GPA#] status of antenatal care patient as reported in a survey. Paritas represent number of times a woman has given birth to a viable offspring (parity)"
...
* code.coding.code = #11977-6 (exactly)
