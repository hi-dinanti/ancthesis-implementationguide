Profile: SyphillisVDRL
Parent: $Observation
Id: SyphillisVDRL
Title: "Syphillis-VDRL (Observation)" 
Description: "Observation representing the screening results for Syphillis (VDRL) as part of the Prevention of Mother-to-Child Transmission of SyphillisVDRL (PPIA) program. This program aims to prevent and control the transmission of these infections from mother to child during pregnancy, childbirth, and breastfeeding."
...
* code.coding.code = #14904-7 (exactly)
* code.coding.display = "Reagin Ab [Presence] in Specimen by VDRL"
