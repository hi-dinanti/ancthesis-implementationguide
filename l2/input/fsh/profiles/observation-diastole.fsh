Profile: DiastoleBloodPressure
Parent: $Observation
Id: DiastoleBloodPressure
Title: "Diastole Blood Pressure (Observation)" 
Description: "Observation representing diastolic blood pressure measurements recorded during an antenatal care visit."
...
* value[x] ^comment = "Value only quantity"
* valueQuantity 1..1
