...
Description: "Observation representing obstetric [GPA#] status of antenatal care patient as reported in a survey. Gravida represents total number of pregnancies."
...
* code.coding.code = #11996-6 (exactly)
* code.coding.display = "[#] Pregnancies"
