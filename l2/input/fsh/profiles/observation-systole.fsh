Profile: SystoleBloodPressure
Parent: $Observation
Id: SystoleBloodPressure
Title: "Systole Blood Pressure (Observation)" 
Description: "Observation representing systolic blood pressure measurements recorded during an antenatal care visit."
