...
Parent: $Observation
Id: HepatitisB
Title: "Hepatitis B (Observation)" 
Description: "Observation representing the screening results for Hepatitis B as part of the Prevention of Mother-to-Child Transmission of HIV (PPIA) program. This program aims to prevent and control the transmission of these infections from mother to child during pregnancy, childbirth, and breastfeeding."
...
* code.coding.code = #22322-2 (exactly)
* code.coding.display = "Hepatitis B virus surface antigen [Presence] in Serum or Plasma"
